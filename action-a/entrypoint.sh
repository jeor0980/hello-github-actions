...
sh -c "git clone https://github.com/CuBoulder/express-mono-upstream.git"
sh -c "cd express-mono-upstream"
sh -c "git checkout -b $EXPRESS_VERSION"
sh -c "cd profiles"
sh -c "rm -rf express"
sh -c "git clone https://github.com/CuBoulder/express_mono.git express"
sh -c "cd express"
